    ...
    return (
      <div className="bg-[#060d1f] rounded-xl border border-white/[0.08] overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.07] bg-white/[0.02]">
          ...
          <div className="flex-1 mx-3 h-5 bg-white/[0.05] rounded text-[10px] text-slate-500 flex items-center px-2 font-mono">
        ...
        <div className="border-t border-white/[0.07] px-4 py-3 space-y-1.5">
          {[
            ...
            <div key={item} className="flex items-center gap-2 text-[10px]">
              ...
              <span className="text-slate-500 font-mono">{item}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="p-3 space-y-2">
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="bg-slate-800/50 rounded p-2">
              ...
              <div className="text-sm font-bold text-cyan-400">23ms</div>
            </div>
            <div className="bg-slate-800/50 rounded p-2">
      ...
      <div className="bg-slate-900 rounded-lg border border-slate-700/50 overflow-hidden">
        ...
        <div className="p-3 space-y-2">
          {[
            ...
            <div key={item.name} className="flex items-center justify-between bg-slate-800/50 rounded px-3 py-2">
  ...
  return (
    <div className="bg-slate-900 rounded-lg border border-slate-700/50 overflow-hidden font-mono">
      ...
      <div className="p-3 text-[11px] leading-relaxed space-y-1">
        <div className="text-slate-500"><span className="text-emerald-400">✓</span> Build — 14s</div>
        <div className="text-slate-500"><span className="text-emerald-400">✓</span> Tests — 247 passed</div>
        <div className="text-slate-500"><span className="text-emerald-400">✓</span> Security scan — 0 vulnerabilities</div>
        <div className="text-slate-500"><span className="text-emerald-400">✓</span> Deploy staging — healthy</div>
        <div className="text-slate-500"><span className="text-emerald-400">✓</span> Deploy production — healthy</div>
