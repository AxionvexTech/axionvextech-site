...
| Asset | Path | Source | Rights | Intended use | Authenticity |
|---|---|---|---|---|---|
...
| Capability strip | `CapabilityStrip.tsx` | Original code | Owned | Homepage signal strip | Brand UI |
...
- Conceptual UIs are labeled “Conceptual UI”, “Example production workflow”, “Reference architecture”, or “Illustrative”.
- Do not present generated scenes as employee photos or client screenshots.
- Replace working-session imagery with approved team photography when available.
